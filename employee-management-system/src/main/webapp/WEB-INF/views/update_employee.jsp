...
<div class="form-box">
    ...
    <frm:form action="update" method="post" modelAttribute="employee">

 <!-- Id -->
        <div class="mb-2">
            <label class="form-label small">EmpId</label>
            <frm:input path="empId" cssClass="form-control form-control-sm" readonly="true"/>
        </div>
        <!-- NAME -->
        <div class="mb-2">
            ...
            <c:forEach var="dept" items="${deptList}">
                <label class="small me-3">
                    <input type="radio" name="deptId" value="${dept.deptId}"
                     <c:if test="${employee.deptId==dept.deptId}">checked</c:if>> 
                    ${dept.deptName}
                </label>
            </c:forEach>
        ...
        <div class="text-center mt-3">
            ...
            <a href="employees" class="btn btn-secondary btn-sm">Back</a>
        </div>
